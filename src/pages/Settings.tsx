  ...
  return (
    <>
      ...
      <div className="overflow-x-hidden bg-[#E7E6E6]">
        <div className="mt-8 flex flex-col sm:flex-row gap-3 px-3 sm:px-6">
          <div className="w-full sm:w-[20%] bg-white rounded-md shadow-md sm:block min-h-3/4">
            <div className="px-3 pt-6 flex flex-col gap-4">
              {sidebarActions.map(({ id, text, icon, link }) => (
                ...
                >
                  ...
                  <Link
                    to={link}
                    className="text-[10px] lg:text-sm font-urbanist"
                  >
                    {text}
                  </Link>
                </div>
